...
public final class FrustumClipper implements Clipper {
    ...
    private boolean isOutside(Vector3d v1, Vector3d v2, Vector3d v3) {
        return
                (frustum.near.compare(v1) == -1 && frustum.near.compare(v2) == -1 && frustum.near.compare(v3) == -1)
                || (frustum.far.compare(v1) == -1 && frustum.far.compare(v2) == -1 && frustum.far.compare(v3) == -1)
                || (frustum.left.compare(v1) == -1 && frustum.left.compare(v2) == -1 && frustum.left.compare(v3) == -1)
                || (frustum.right.compare(v1) == -1
                        && frustum.right.compare(v2) == -1
                        && frustum.right.compare(v3) == -1)
                || (frustum.top.compare(v1) == -1 && frustum.top.compare(v2) == -1 && frustum.top.compare(v3) == -1)
                || (frustum.bottom.compare(v1) == -1
